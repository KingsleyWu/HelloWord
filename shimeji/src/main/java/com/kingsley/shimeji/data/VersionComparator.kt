...
import com.kingsley.shimeji.data.SQLiteAssetHelper.SQLiteAssetException
...
internal class VersionComparator : Comparator<String> {
    ...
    override fun compare(file0: String, file1: String): Int {
        ...
        val v0_from: Int = Integer.valueOf(m0.group(1))
        val v1_from: Int = Integer.valueOf(m1.group(1))
        val v0_to: Int = Integer.valueOf(m0.group(2))
        val v1_to: Int = Integer.valueOf(m1.group(2))
        if (v0_from == v1_from) {
