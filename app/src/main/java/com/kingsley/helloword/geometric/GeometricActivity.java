...
public class GeometricActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = new Intent(GeometricActivity.this, DisplayActivity.class);
    }
    ...
    private void createShapeDBDialog() {
        Builder builder = new Builder(this, android.R.style.Theme_Material_Light_Dialog_Alert);
        ...
        builder.setItems(DBitems, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                GeometricActivity.this.onClick(null);
            }
        });
