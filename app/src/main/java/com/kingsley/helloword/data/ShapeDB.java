...
public class ShapeDB {
     ...
     * @param shapeHolder
     */
    public static void addSquare(ShapeHolder shapeHolder) {
        shapeHolder.add(new Cuboid(100, 500, 10));
        Shape cuboid = new Cuboid(100, 100, 10);
        cuboid.moveDirection(100, 200, 0);
        shapeHolder.add(cuboid);
        Shape cuboid2 = new Cuboid(100, 200, 10);
        cuboid2.moveDirection(200, 150, 0);
     ...
     * @param shapeHolder
     */
    public static void add2(ShapeHolder shapeHolder) {
        Shape a = new Prism(4, 2, 500);
        a.moveDirection(150 - 2, 0, 0);
        shapeHolder.add(a);
        Shape b = new Prism(4, 2, 400);
        b.moveDirection(50 - 2, 0, 50);
        shapeHolder.add(b);

        Shape e = new Prism(4, 2, 500);
        e.deflectDegree(90, 90);
        shapeHolder.add(e);

        Shape c = new Prism(4, 2, 100);
        c.moveDirection(-50 - 2, 0, -100);
        shapeHolder.add(c);

        Shape d = new Prism(4, 2, 200);
        d.moveDirection(-150 - 2, 0, -150);
        shapeHolder.add(d);
