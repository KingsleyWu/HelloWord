...
public class FloatWindowPermissionChecker {
    ...
    private static final String TOAST_HINT = "Can't open settings";
    ...
    private static boolean startActivitySafely(Intent intent, Context context) {
        return startActivitySafely(intent, context, Intent.FLAG_ACTIVITY_NEW_TASK);
    }

    private static boolean startActivitySafely(Intent intent, Context context, int flags) {
