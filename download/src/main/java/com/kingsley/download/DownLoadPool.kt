...
object DownLoadPool {
    ...
    fun getScopeFromKey(key: String): CoroutineScope? = scopeMap[key]

    fun getListenerFromKey(key: String): OnDownLoadListener? = listenerHashMap[key]

    fun getPathFromKey(key: String): String? = pathMap[key]

    fun getListenerMap(): ConcurrentHashMap<String, OnDownLoadListener> = listenerHashMap
